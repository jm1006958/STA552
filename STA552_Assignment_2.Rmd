---
title: "STA552 Assignment 3 - Imputation"
author: " Junjie Mei"
date: " 02/25/2025 "
output:
  html_document: 
...
complete(imp, action = 1L)[1:200,]  # The default *action = 1L* returns the first

```

TotalAmount and ActualAmount are positively correlated based on the paired plot above. Due to my problem, I did not have time to do 4 task in this Multiple Imputation homework, but I will make it up later when I have some more time. Thanks!
